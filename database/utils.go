...
// FormatJSON is ...
func FormatJSON(jsonObj any) string {
...
// value:结构体的反射值
// data:存储字段数据的map
func StructToMap(value reflect.Value, data map[string]any) {
...
func MapChangeKeyCase(values map[string]any, caseUpper bool) map[string]any {
    valueMaps := make(map[string]any, len(values))
