...
func (s *Schema) CreateDatabase(database string, args ...any) (err error) {
    var (
...
func (s *Schema) CreateTable(table string, fields []map[string]any, args ...any) (err error) {
    var (
        primaryKeys []string
        ifNotExists bool   = true
...
func (s *Schema) CreateIndex(table string, indexColumns any, indexName, index string) (err error) {
...
func (s *Schema) AddForeignKey(table string, foreignKey []map[string]any) (err error) {
...
func (s *Schema) AddFields(table string, fields []map[string]any) error {
    return s.Dialector.AddFields(table, fields, s.DB)
}

// DropFields drops fields from a table.
func (s *Schema) DropFields(table string, value any) error {
    return s.Dialector.DropFields(table, value, s.DB)
}

// ModifyFields alters fields in a table.
func (s *Schema) ModifyFields(table string, fields []map[string]any) error {
    return s.Dialector.ModifyFields(table, fields, s.DB)
}

// AlterFields is ...
//func (s *Schema) AlterFields(alterType, table string, fields any) (err error) {
//return s.Dialector.AlterFields(alterType, table, fields, s.DB)
//}

// ProcessFields is ...
func (s *Schema) ProcessFields(fields []map[string]any, prefix string) string {
