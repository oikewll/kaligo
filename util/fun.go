...
// 获取域名信息
// func GetRootDomain(urls string) (root, tld string, isOK bool) {
//     ra, err := regexp.Compile("^(http:|https:)")
//     if err != nil {
//         olog.Error("GetRootDomain regexp.Compile error:%v url:%v", err, urls)
//         return "", "", false
//     }
...
//     if err != nil {
//         olog.Error("GetRootDomain url.Parse error:%v url:%v", err, urls)
//         return "", "", false
//     }
//
//     host = r.Hostname()
...
//     tld, isOK = publicsuffix.PublicSuffix(host)
